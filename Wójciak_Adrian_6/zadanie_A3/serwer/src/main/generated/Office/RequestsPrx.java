...
public interface RequestsPrx extends com.zeroc.Ice.ObjectPrx
{
     ...
     **/
    static RequestsPrx checkedCast(com.zeroc.Ice.ObjectPrx obj)
    {
        return com.zeroc.Ice.ObjectPrx._checkedCast(obj, ice_staticId(), RequestsPrx.class, _RequestsPrxI.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    static RequestsPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, java.util.Map<String, String> context)
    {
        return com.zeroc.Ice.ObjectPrx._checkedCast(obj, context, ice_staticId(), RequestsPrx.class, _RequestsPrxI.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    static RequestsPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, String facet)
    {
        return com.zeroc.Ice.ObjectPrx._checkedCast(obj, facet, ice_staticId(), RequestsPrx.class, _RequestsPrxI.class);
    }
     ...
     * @return A proxy for this type, or null if the object does not support this type.
     **/
    static RequestsPrx checkedCast(com.zeroc.Ice.ObjectPrx obj, String facet, java.util.Map<String, String> context)
    {
        return com.zeroc.Ice.ObjectPrx._checkedCast(obj, facet, context, ice_staticId(), RequestsPrx.class, _RequestsPrxI.class);
    }
     ...
     **/
    static RequestsPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj)
    {
        return com.zeroc.Ice.ObjectPrx._uncheckedCast(obj, RequestsPrx.class, _RequestsPrxI.class);
    }
     ...
     * @return A proxy for this type.
     **/
    static RequestsPrx uncheckedCast(com.zeroc.Ice.ObjectPrx obj, String facet)
    {
        return com.zeroc.Ice.ObjectPrx._uncheckedCast(obj, facet, RequestsPrx.class, _RequestsPrxI.class);
    }
     ...
     **/
    @Override
    default RequestsPrx ice_context(java.util.Map<String, String> newContext)
    {
        return (RequestsPrx)_ice_context(newContext);
    }
     ...
     **/
    @Override
    default RequestsPrx ice_adapterId(String newAdapterId)
    {
        return (RequestsPrx)_ice_adapterId(newAdapterId);
    }
     ...
     **/
    @Override
    default RequestsPrx ice_endpoints(com.zeroc.Ice.Endpoint[] newEndpoints)
    {
        return (RequestsPrx)_ice_endpoints(newEndpoints);
    }
     ...
     **/
    @Override
    default RequestsPrx ice_locatorCacheTimeout(int newTimeout)
    {
        return (RequestsPrx)_ice_locatorCacheTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default RequestsPrx ice_invocationTimeout(int newTimeout)
    {
        return (RequestsPrx)_ice_invocationTimeout(newTimeout);
    }
     ...
     **/
    @Override
    default RequestsPrx ice_connectionCached(boolean newCache)
    {
        return (RequestsPrx)_ice_connectionCached(newCache);
    }
     ...
     **/
    @Override
    default RequestsPrx ice_endpointSelection(com.zeroc.Ice.EndpointSelectionType newType)
    {
        return (RequestsPrx)_ice_endpointSelection(newType);
    }
     ...
     **/
    @Override
    default RequestsPrx ice_secure(boolean b)
    {
        return (RequestsPrx)_ice_secure(b);
    }
     ...
     **/
    @Override
    default RequestsPrx ice_encodingVersion(com.zeroc.Ice.EncodingVersion e)
    {
        return (RequestsPrx)_ice_encodingVersion(e);
    }
     ...
     **/
    @Override
    default RequestsPrx ice_preferSecure(boolean b)
    {
        return (RequestsPrx)_ice_preferSecure(b);
    }
     ...
     **/
    @Override
    default RequestsPrx ice_router(com.zeroc.Ice.RouterPrx router)
    {
        return (RequestsPrx)_ice_router(router);
    }
     ...
     **/
    @Override
    default RequestsPrx ice_locator(com.zeroc.Ice.LocatorPrx locator)
    {
        return (RequestsPrx)_ice_locator(locator);
    }
     ...
     **/
    @Override
    default RequestsPrx ice_collocationOptimized(boolean b)
    {
        return (RequestsPrx)_ice_collocationOptimized(b);
    }
     ...
     **/
    @Override
    default RequestsPrx ice_twoway()
    {
        return (RequestsPrx)_ice_twoway();
    }
     ...
     **/
    @Override
    default RequestsPrx ice_oneway()
    {
        return (RequestsPrx)_ice_oneway();
    }
     ...
     **/
    @Override
    default RequestsPrx ice_batchOneway()
    {
        return (RequestsPrx)_ice_batchOneway();
    }
     ...
     **/
    @Override
    default RequestsPrx ice_datagram()
    {
        return (RequestsPrx)_ice_datagram();
    }
     ...
     **/
    @Override
    default RequestsPrx ice_batchDatagram()
    {
        return (RequestsPrx)_ice_batchDatagram();
    }
     ...
     **/
    @Override
    default RequestsPrx ice_compress(boolean co)
    {
        return (RequestsPrx)_ice_compress(co);
    }
     ...
     **/
    @Override
    default RequestsPrx ice_timeout(int t)
    {
        return (RequestsPrx)_ice_timeout(t);
    }
     ...
     **/
    @Override
    default RequestsPrx ice_connectionId(String connectionId)
    {
        return (RequestsPrx)_ice_connectionId(connectionId);
    }
     ...
     **/
    @Override
    default RequestsPrx ice_fixed(com.zeroc.Ice.Connection connection)
    {
        return (RequestsPrx)_ice_fixed(connection);
    }
